...
public class MedicalTest {
    ...
    public static void main(String[] args) {
        ...
        testResults.add(new MedicalTestResult("sai", 60.0));
        testResults.add(new MedicalTestResult("Kiran", 120.0));
        testResults.add(new MedicalTestResult("vamshi", 160.0));
        testResults.add(new MedicalTestResult("subbu", 105.0));
        testResults.add(new MedicalTestResult("ajith", 150.0));
